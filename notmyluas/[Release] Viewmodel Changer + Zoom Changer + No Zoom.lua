-- Scraped by chicken
-- Author: Spekbillen
-- Title [Release] Viewmodel Changer + Zoom Changer + No Zoom
-- Forum link https://aimware.net/forum/thread/133104

local REF = gui.Reference( "Visuals", "Local")
local ZOOMGROUP = gui.Groupbox(REF, "Scope Zoom", 16, 267, 295, 50)
local VIEWGROUP = gui.Groupbox(REF, "Viewmodel", 328, 267, 295, 50)
