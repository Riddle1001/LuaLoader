-- Scraped by chicken
-- Author: proobitaz
-- Title [Release] Rainbow88's Ragebot essentials selfleak
-- Forum link https://aimware.net/forum/thread/131912
...
local desync_break_font = draw.CreateFont("Segoe UI", 30, 400)
-- References
