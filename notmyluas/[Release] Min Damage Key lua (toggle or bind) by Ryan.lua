-- Scraped by chicken
-- Author: Ryanchiew
-- Title [Release] Min Damage Key lua (toggle or bind) by Ryan
-- Forum link https://aimware.net/forum/thread/130627
...
local awpDamage = gui.Slider(dmgsettings, "awpDamage", "Awp Min Damage", 1, 0, 100)
...
local scoutDamage = gui.Slider(dmgsettings, "scoutDamage", "Scout Min Damage", 1, 0, 100)
...
local autoDamage = gui.Slider(dmgsettings, "autoDamage", "Auto Min Damage", 1, 0, 100)
