...
label = gui.Tab(gui.Reference("Ragebot"), "aa.settings", "pastel AA")
text = gui.Text(label, "Thanks for using my LUA! Check out my channel: youtube.com/pastel420") 
noir = 15
blanc = -15
oranges = 40
p = -40
...
label = gui.Tab(gui.Reference("Ragebot"), "aa.settings", "pastel AA")
text = gui.Text(label, "youtube.com/pastel420 :)") 
noir = 15
blanc = -15
oranges = 40
p = -40
