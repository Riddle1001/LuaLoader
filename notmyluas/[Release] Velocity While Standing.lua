-- Scraped by chicken
-- Author: scripted
-- Title [Release] Velocity While Standing
-- Forum link https://aimware.net/forum/thread/112971

local misc_movement_ref = gui.Reference("MISC", "AUTOMATION", "MOVEMENT")
local velocity_on_stand_enable = gui.Checkbox( misc_movement_ref, "velocity_on_stand_enabled", "Enable velocity on stand", false)
local velocity_on_stand = gui.Slider(misc_movement_ref, "velocity_on_stand","Velocity while standing", 5, 1, 10);
