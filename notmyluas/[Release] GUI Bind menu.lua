-- Scraped by chicken
-- Author: QBER
-- Title [Release] GUI Bind menu
-- Forum link https://aimware.net/forum/thread/87009


--Here you can change code
--Function name
local function_list = {"Anti-Aim Yaw +90", "Anti-Aim Yaw -90", "Third Person ON", "Third Person OFF", "ASUS Walls ON", "ASUS Walls OFF","Send '1' in Chat","None","None","None"}
...
show_hide_menu()
	...
	draw.TextShadow( pos_x+3, pos_y+body_h+top_h+3, "V1 Creator by QBER" )
