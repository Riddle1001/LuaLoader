...
                else
                    drawText(255, 255, 255, 255, damageLogX + paddingW + usedW + textDistance + (tableElementsSize[i]), damageLogY + paddingH + (height / 2), barFont, tableElements[i], 3)
                    usedW = usedW + textDistance + tableElementsSize[i]
                end
            end
...
callbacks.Register('Draw', drawHUDs);[/i][/i][/i][/i][/i][/i][/i][/i][/i][/i][/i][/i][/i][/i]