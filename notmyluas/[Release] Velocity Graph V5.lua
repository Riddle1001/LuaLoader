-- Scraped by chicken
-- Author: Kawurftha
-- Title [Release] Velocity Graph V5
-- Forum link https://aimware.net/forum/thread/128029
...
end)[/i][/i][/i][/i][/i]-- Scraped by chicken
-- Author: cippak
-- Title [Release] velocity graph v5
-- Forum link https://aimware.net/forum/thread/133949
...
bMakeGraphScalableWithResolution = false -- Causes uiGraphWidth and uiGraphMaxY to be ignored, instead graph size will be dynamically calculated from screen size

bRenderBoxGlobal = true -- Renders a box around the graph. Requires bMakeGraphScalableWithResolution enabled to work
boxColor = {255, 255, 255, 255} -- box color in rgba format
